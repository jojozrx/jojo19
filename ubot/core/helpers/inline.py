...
class Button:
    ...
    def button_add_expired(user_id):
        ...
        buttons.row(
            InlineKeyboardButton(
                "Account Link", callback_data=f"profil {user_id}"
            )
        )
        buttons.row(
            InlineKeyboardButton(
                "Reject Payment", callback_data=f"failed {user_id}"
            )
        )
        return buttons
        ...
        if message.from_user.id not in USER_ID:
            button = [
                ...
                [
                    ...
                    InlineKeyboardButton("Account Status", callback_data="start_profile"),
                ],
            ]
        else:
            button = [
    ...
    def userbot(user_id, count):
        button = [
            ...
            [
                InlineKeyboardButton(
                    "Destroyed", callback_data=f"ub_deak {int(count)}"
                )
            ],
            [
